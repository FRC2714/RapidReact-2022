...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    autoChooser.addOption("Two Ball Steal Auton", robotContainer.getTwoBallAuto());
    autoChooser.addOption("Shoot and Grab 1 other ball to Shoot", robotContainer.getSideShootAuto());
